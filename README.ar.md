...
## إدارة المستندات في السحابة أو منصات الحاويات

**OpenProdoc Red** هو تغليف في حاويات [Docker](https://ar.wikipedia.org/wiki/%D8%AF%D9%88%D9%83%D8%B1_(%D8%A8%D8%B1%D9%86%D8%A7%D9%85%D8%AC)) لنظام إدارة المستندات [OpenProdoc](https://jhierrot.github.io/openprodoc/) مدمج مع حاويات موجهة لـ**الذكاء الاصطناعي** تتيح التفاعل مع مستودع المستندات من خلال روبوت محادثة متقدم. بالإضافة إلى ذلك، يتيح المشروع المطوّر تضمين معلومات من مستودع المستندات لـ**تخصيص الاستجابات** ([RAG](https://en.wikipedia.org/wiki/Retrieval-augmented_generation))، وكل ذلك **دون الحاجة إلى نشر المعلومات على الإنترنت**، باستخدام محركات ذكاء اصطناعي محلية.

يتيح استخدام الحاويات النشر في **بيئات إنتاجية وقابلة للتوسع بشكل كبير** باستخدام منصات مثل [Kubernetes](https://ar.wikipedia.org/wiki/%D9%83%D9%88%D8%A8%D8%B1%D9%86%D9%8A%D8%AA%D8%B3). وفقاً للاحتياجات، **يمكن توسيع كل مكون على حدة**.
...
على الرغم من أن العناصر الرئيسية لبنية OpenProdoc Red محددة مسبقاً (مثل قاعدة البيانات)، تظل العناصر الأخرى من [البنية المعمارية القياسية لـ OpenProdoc](https://jhierrot.github.io/openprodoc/help/EN/Architect.html) متاحة، مثل بدائل المصادقة أو تخزين أنواع معينة من المستندات في مستودعات أخرى.
...
## 📡 التطوير وواجهة برمجة التطبيقات REST لـ OpenProdoc

يتضمن OpenProdoc واجهة برمجة تطبيقات REST كاملة تُنشر أيضاً في حاويات هذا المشروع لتسهيل التطوير والتكامل.
...
بالإضافة إلى واجهة برمجة التطبيقات REST، **يمتلك OpenProdoc واجهة برمجة تطبيقات Java وإمكانية تطوير تكاملات تشمل جميع الوظائف، بما في ذلك الإدارة**.

التوثيق الكامل لتطوير OpenProdoc (Java، REST، التكوين المتقدم، إلخ) متاح على: [Development SDK](https://jhierrot.github.io/openprodoc/Docs/OPD_Development3.0.2.html)
...
## 🔄 الترحيل من تثبيتات OpenProdoc الموجودة

يحافظ OpenProdoc Red على نموذج بيانات OpenProdoc. إذا كانت قاعدة البيانات المستخدمة هي PostgreSQL، فإن **التوافق كامل** ويتضمن الترحيل:

1. **تصدير قاعدة البيانات الموجودة** من OpenProdoc
...
**إذا كان التثبيت الحالي يستخدم قاعدة بيانات أخرى، فإن الترحيل ممكن أيضاً، وإن كان أكثر تعقيداً بقليل.**

التوصية هي تصدير التعريفات (المستخدمون، المجموعات، أنواع المستندات، المهام، إلخ) من خيارات الإدارة، ثم باستخدام عميل OpenProdoc Swing السميك (راجع خيارات البنية المعمارية) تصدير فروع المجلدات بالكامل إلى نظام ملفات واستيرادها في البيئة الجديدة، أيضاً باستخدام العميل السميك.
...
* **[مساعدة OpenProdoc عبر الإنترنت](https://jhierrot.github.io/openprodoc/help/EN/HelpIndex.html)** - مساعدة OpenProdoc متاحة أيضاً في قائمة المساعدة بعد التثبيت.
* **[دليل OpenProdoc المفصل](https://jhierrot.github.io/openprodoc/Docs/Introducci%C3%B3nG.D.OpenProdoc.html)** - وثيقة PDF تشرح تدريجياً جميع وظائف OpenProdoc، بما في ذلك الإدارة والتكوين.
...
**OpenProdoc** - من إنشاء Joaquín Hierro

**OpenProdoc Red** - الحاوية السحابية الأصلية، قدرات الذكاء الاصطناعي ونشر Kubernetes
