...
OpenProdoc Red هو تغليف في حاويات Docker لنظام إدارة المستندات OpenProdoc مدمج مع حاويات موجهة للذكاء الاصطناعي تتيح التفاعل مع مستودع المستندات من خلال روبوت محادثة متقدم. بالإضافة إلى ذلك، يتيح المشروع المطوّر تضمين معلومات من مستودع المستندات لتخصيص الاستجابات (RAG)، وكل ذلك دون الحاجة إلى نشر المعلومات على الإنترنت، باستخدام محركات ذكاء اصطناعي محلية.

يتيح استخدام الحاويات النشر في بيئات إنتاجية وقابلة للتوسع بشكل كبير باستخدام منصات مثل Kubernetes. وفقاً للاحتياجات، يمكن توسيع كل مكون على حدة.
